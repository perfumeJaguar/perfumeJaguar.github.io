...
window.DODREI_CONFIG = {
  meta: { project: "DODREI", schemaVersion: 1, configRevision: 31, generatedBy: "hand-or-control" },
  app: { title: "DODREI", version: "1.0.20", targetFps: 60, requestFullscreenOnStart: false, preventContextMenu: true, modeDurationSec: 11, imageSwitchSec: 0.10, startScreenHoldMs: 2000, telemetryStartDelayMs: 3000, telemetryStaggerMs: 200, visualDimDelayAfterTelemetryMs: 3000, visualFullDelayAfterDimMs: 1000 },
  timing: { compositionFps: 30, visualSpeedLevel: "S2", visualSpeedMultiplier: 0.50, visualStateIntervalMs: 45, cutSpeedLevel: "S2", cutIntervalMs: 240, timeReferenceFps: 60, maxDeltaMs: 100 },
  ...
  visual: {
    ...
    touchPalette: { thresholds: [64,128,192], colors: [[0,0,0],[72,72,72],[156,156,156],[246,246,244]] },
