...
window.DODREI_CONFIG = {
  meta: { project: "DODREI", schemaVersion: 1, configRevision: 22, generatedBy: "hand-or-control" },
  app: { title: "DODREI", version: "1.0.10", targetFps: 60, requestFullscreenOnStart: false, preventContextMenu: true, modeDurationSec: 11, imageSwitchSec: 0.10, startScreenHoldMs: 3000, telemetryStartDelayMs: 3000, telemetryStaggerMs: 200, visualDimDelayAfterTelemetryMs: 3000, visualFullDelayAfterDimMs: 1000 },
  ...
  audio: { enabled: true, masterVolume: 0.82, directNativeOutput: true, pcmWindowSize: 512, waveformPoints: 128, minRate: 0.985, maxRate: 1.015, lumaRateMin: 0.99, lumaRateMax: 1.01, pressRateBoost: 0.006, fxEnabled: true, fxWetMin: 0.025, fxWetMax: 0.72, minFilterHz: 120, maxFilterHz: 12500, maxDelayTime: 0.68, maxDelayFeedback: 0.82, maxDistortion: 0.88, touchFxDryDuck: 0.28, touchFxWetScale: 0.45, touchFxDirectGainBase: 0.34, touchFxDirectGainPress: 0.12, touchFxDelayGainScale: 0.72, touchFxDistortionScale: 0.65, touchFxFeedbackScale: 0.68, touchFxResonanceMaxQ: 6.8 },
  visual: {
    enabled: true,
    sceneImageSelectionPolicy: "independent-with-replacement",
    sourceCropMinZoom: 1.0, sourceCropMaxZoom: 9.0, sourceCropTouchBoost: 0.0, sourceCropPanFactor: 0.42, sourceCropOverflowPan: 1.0,
    ...
    preCommonFx: {},
    postCommonFx: { masterEnabled: true, bw: false, grayscale: false, lowSaturation: true, blur: true, crush: false, highContrast: true, darken: false, strongVignette: false, order: ["highContrast","lowSaturation","blur"], bwThreshold: 0.50, lowSaturationAmount: 0.50, blurAmountPx: 1.20, highContrastAmount: 3.20, highContrastSaturation: 1.08, darkenAlpha: 0.46, strongVignetteStrength: 0.96, strongVignetteInner: 0.16, strongVignetteOuter: 0.72 },
