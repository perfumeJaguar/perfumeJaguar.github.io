...
window.DODREI_CONFIG = {
  ...
  visual: {
    enabled: true, sourceCropMinZoom: 1.0, sourceCropMaxZoom: 3.0, sourceCropTouchBoost: 0.0, sourceCropPanFactor: 0.42, sourceCropOverflowPan: 1.0, touchTransitionSlowdown: 0.28,
